...
public class LevelFragment extends Fragment {
    ...
    /*private List<Question> getListMath1(){
        List<Question> list1 = new ArrayList<>();
        list1.add(new Question("1. Toan hoc de cau 1", true));
        list1.add(new Question("2. Toan hoc de cau 2", false));
        list1.add(new Question("3. Toan hoc de cau 3", false));
        return list1;
    }

    private static final List<Question> math1 = new ArrayList<>(Arrays.asList(
            new Question("1. Toan hoc de cau 1", true),
            new Question("2. Toan hoc de cau 2", false),
            new Question("3. Toan hoc de cau 3", false)
    ));
    private static final List<Question> math2 = new ArrayList<>(Arrays.asList(
            new Question("1. Toan hoc trung binh cau 1", true),
    ...
    private static final List<Question> music1 = new ArrayList<>(Arrays.asList(
            ...
            new Question("3. Am nhac de cau 3", true)
